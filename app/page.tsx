      ...
      <div className="grid md:grid-cols-2 h-max items-center flex-wrap justify-center gap-[clamp(20px,5.5vw,100px)] relative">
        <LgBoardBloom className="animitem h-full flex-1 basis-0 min-w-80 cursor-pointer" onClick={() => r.push("/lnt")}>
          <div className="w-full flex flex-col gap-4 p-4 md:p-5">
            <div className="mx-auto w-8/10 pt-[10%]">
              <LntNodeSvg />
            </div>
            <div className="text-2xl font-semibold">LNT - Vaults</div>
            <div className="font-sec opacity-60 text-sm">
              LNT (Liquid Node Token) Vault is a decentralized protocol
              designed to facilitate the issuance and management of ..</div>
          </div>
        </LgBoardBloom>
        <LgBoardBloom2 className="animitem flex-1 basis-0 min-w-80 cursor-pointer" onClick={() => r.push("/lvt")}>
          <div className="w-full flex flex-col gap-4 p-4 md:p-5">
            ...
            <div className="font-sec opacity-60 text-sm">
              LVT (Liquid Vesting Token) Vault is a smart new way to make
              locked-up tokens in crypto projects tradeable right away ..</div>
          </div>
        </LgBoardBloom2>
        <div className="bg-[#21CA53] opacity-20 blur-[150px] rotate-30 -translate-y-1/2 -translate-x-1/2 w-[clamp(300px,46vw,650px)] aspect-65/43 origin-center absolute left-0"></div>
        <div className="bg-[#FDD849] opacity-20 blur-[150px] -rotate-30 -translate-y-1/2 translate-x-1/2 w-[clamp(300px,46vw,650px)] aspect-65/43 origin-center absolute right-0"></div>
      </div>
    </div>
  </>
}
